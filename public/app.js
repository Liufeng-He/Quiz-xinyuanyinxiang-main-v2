...
const optionSets = {
  ...
  primaryFocus: [
    ...
    ["activities", "🎪 学生活动与校园氛围（哪里热闹点哪里）", "陪伴"], ["culture", "🧸 吉祥物、文创与视觉形象（让它们多出来营业）", "陪伴"]
  ],
  future: [
...
function renderKeywords() {
  ...
  const suggestions = [['情绪', '🌤️ 情绪'], ['认知', '🧠 认知'], ['行为', '👣 行为'], ['人际关系', '🤝 人际关系'], ['发展', '🌱 发展'], ['大脑', '🧬 大脑'], ['学习', '📚 学习'], ['幸福感', '☀️ 幸福感'], ['压力', '🌋 压力'], ['梦', '🌙 梦（这一项要看研究方向）']];
